...
steepest_ascent = 
  ...
  sum_sq_betas_diff = 10
  betas_new = rep(0.5, 4)
  
  while( sum_sq_betas_diff > epsilon ){
    ...
    sum_sq_betas_diff = sum((betas_new - betas_old)^2)
...
steepest_ascent(X, betas_old = betas,
                h = 10^(-6), ydum, learning_rate = 0.000001, epsilon = .00000001)
...
Values from the optim function and the base package lm function are not different at all, with the maximum difference in coefficients being 0.0025. This maximum quantity can be considered neglegible. \newline

X1: An increase in X1 increases the ydum variable. \newline
X2: An increase in X2 decreases the ydum variable. \newline
X3: An increase in X3 increases the ydum variable. \newline

Logistic Regression: \newline

Values from the optim function and the base package glm function are not different at all, with the maximum difference in coefficients being 0.0004. This maximum quantity can be considered neglegible. \newline

X1: An increase in X1 increases the likelihood of ydum = 1. \newline
X2: An increase in X2 decreases the likelihood of ydum = 1. \newline
X3: An increase in X3 increases the likelihood of ydum = 1. \newline

Probit Regression: \newline

Values from the optim function and the base package glm function are not different at all, with the maximum difference in coefficients being 0.0007. This maximum quantity can be considered neglegible. \newline
